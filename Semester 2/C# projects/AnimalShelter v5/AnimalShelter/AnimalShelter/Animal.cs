...
namespace AnimalShelter
{
    ...
    /// </summary>
    [Serializable]
    abstract class Animal :Iprijsbaar, IComparable<Animal>
    {
        /// <summary>
        ...
        public Animal(string chipRegistrationNumber, SimpleDate dateOfBirth, string name, Gender gender)
        {
        ...
        {
            return this.ChipRegistrationNumber.CompareTo(animal.ChipRegistrationNumber);
        }

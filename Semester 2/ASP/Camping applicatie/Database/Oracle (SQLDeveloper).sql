...
Insert into ACCOUNT_BIJDRAGE (ID,"account_id","bijdrage_id","like","ongewenst") values (5,3,15,1,0);
Insert into ACCOUNT_BIJDRAGE (ID,"account_id","bijdrage_id","like","ongewenst") values (6,3,14,0,0);
Insert into ACCOUNT_BIJDRAGE (ID,"account_id","bijdrage_id","like","ongewenst") values (7,3,13,0,0);
Insert into ACCOUNT_BIJDRAGE (ID,"account_id","bijdrage_id","like","ongewenst") values (8,1,16,0,0);
REM INSERTING into BERICHT
SET DEFINE OFF;
Insert into BERICHT ("bijdrage_id","bijdrage_id_over","titel","inhoud","likes","ongewenst") values (13,null,'Zwemmen','Om 2 uur wil ik gaan zwemmen wie gaat er mee',3,0);
Insert into BERICHT ("bijdrage_id","bijdrage_id_over","titel","inhoud","likes","ongewenst") values (14,null,'Reclame','Zoek Singles in jouw buurt',0,5);
Insert into BERICHT ("bijdrage_id","bijdrage_id_over","titel","inhoud","likes","ongewenst") values (15,14,'Singles.nl','Oke',0,0);
Insert into BERICHT ("bijdrage_id","bijdrage_id_over","titel","inhoud","likes","ongewenst") values (16,null,'Admin Mededeling','Om 3uur zal er een toernooi plaatsvinden. In het hoofdgebouw.',22,0);
...
Insert into BIJDRAGE (ID,"account_id","datum","soort") values (14,2,to_date('14-OCT-13 00:00:00','DD-MON-RR HH24:MI:SS'),'bericht');
Insert into BIJDRAGE (ID,"account_id","datum","soort") values (15,3,to_date('28-OCT-13 00:00:00','DD-MON-RR HH24:MI:SS'),'bericht');
Insert into BIJDRAGE (ID,"account_id","datum","soort") values (16,3,to_date('28-OCT-13 00:00:00','DD-MON-RR HH24:MI:SS'),'bericht');
...
Insert into PLEK (ID,"locatie_id","nummer","capaciteit") values (4,1,'4',5);
Insert into PLEK (ID,"locatie_id","nummer","capaciteit") values (5,1,'5',5);
Insert into PLEK (ID,"locatie_id","nummer","capaciteit") values (6,1,'6',5);
...
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (10,3,4,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (11,3,5,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (12,3,6,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (13,4,4,'30');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (14,4,5,'30');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (15,4,6,'30');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (16,5,4,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (17,5,5,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (18,5,6,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (19,2,4,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (20,2,5,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (21,2,6,'ja');
Insert into PLEK_SPECIFICATIE ("id","specificatie_id","plek_id","waarde") values (22,2,3,'nee');
REM INSERTING into POLSBANDJE
SET DEFINE OFF;
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (1,'1009183947385',123456789,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (2,'2032402794001',123456788,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (3,'3395637655752',123456787,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (4,'0184032037279',123456786,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (5,'4536466650894',123456785,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (6,'0924378392966',123456784,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (7,'4587493495545',123456783,1);
Insert into POLSBANDJE (ID,"rfid","nummer","actief") values (8,'2235200858405',123456782,1);
...
--------------------------------------------------------
  ...
  --ALTER TABLE "ACCOUNT" ADD CONSTRAINT "PERSOONACCOUNT" FOREIGN KEY ("persoon_id")
  --  REFERENCES "PERSOON" ("ID") ENABLE;
    
--------------------------------------------------------
--  Ref Constraints for Table PERSOON
--------------------------------------------------------
  --ALTER TABLE "PERSOON" ADD CONSTRAINT "ACCOUNTPERSOON" FOREIGN KEY ("account_id")

...
insert into PERSOON (PersoonID, Voornaam, Achternaam, Adres, Geboortedatum)
values (5,'Annie','Schoon','Adminstraat 7',TO_DATE('1990-11-11', 'YYYY-MM-DD'));
insert into PERSOON (PersoonID, Voornaam, Achternaam, Adres, Geboortedatum)
values (6,'Herman','Beheer' ,'Adminstraat 7',TO_DATE('1990-11-11', 'YYYY-MM-DD'));
insert into PERSOON (PersoonID, Voornaam, Achternaam, Adres, Geboortedatum)
values (7,'Jos','Techniek' ,'Adminstraat 7',TO_DATE('1990-11-11', 'YYYY-MM-DD'));
insert into PERSOON (PersoonID, Voornaam, Achternaam, Adres, Geboortedatum)
values (8,'Rene','bestuurder' ,'Adminstraat 7',TO_DATE('1990-11-11', 'YYYY-MM-DD'));
insert into PERSOON (PersoonID, Voornaam, Achternaam, Adres, Geboortedatum)
values (9,'Astrid','wagenpark' ,'Adminstraat 7',TO_DATE('1990-11-11', 'YYYY-MM-DD'));
insert into PERSOON (PersoonID, Voornaam, Achternaam, Adres, Geboortedatum)
values (10,'Admin','Admin' ,'Adminstraat 7',TO_DATE('1990-11-11', 'YYYY-MM-DD'));
...
insert into ACCOUNT (PersoonID, Gebruikersnaam, Wachtwoord, StatusAccountNr)
values (5,'Annie','Annie',3);
insert into ACCOUNT (PersoonID, Gebruikersnaam, Wachtwoord, StatusAccountNr)
values (6,'Herman','Herman',1);
insert into ACCOUNT (PersoonID, Gebruikersnaam, Wachtwoord, StatusAccountNr)
values (7,'Jos','Jos',4);
insert into ACCOUNT (PersoonID, Gebruikersnaam, Wachtwoord, StatusAccountNr)
values (8,'Rene','Rene',5);
insert into ACCOUNT (PersoonID, Gebruikersnaam, Wachtwoord, StatusAccountNr)
values (9,'Astrid','Astrid',2);
insert into ACCOUNT (PersoonID, Gebruikersnaam, Wachtwoord, StatusAccountNr)
values (10,'admin','admin',1);
...
-- TRAM
-- combino's
insert into TRAM (TramNr, TramTypeNr, StatusTramNr, SectorID, RFIDNR)
values (2001, 1, 3, null, '1c00fcb288');
insert into TRAM (TramNr, TramTypeNr, StatusTramNr, SectorID, RFIDNR)
values (2002, 1, 3, null, '28005ecb8c');
insert into TRAM (TramNr, TramTypeNr, StatusTramNr, SectorID, RFIDNR)
values (2003, 1, 3, null, '1c00fcfe8f');
...
values (3,2003,3,TO_DATE('22-04-2015','DD-MM-YYYY'), TO_DATE('22-04-2015 13:00','DD-MM-YYYY HH24:MI'), 'Groot');
insert into SCHOONMAAK (SchoonmaakNr, TramNr, PersoonID, BeginDatum, EindDatumTijd, Soortbeurt)
values (4,2004,5,TO_DATE('22-04-2015','DD-MM-YYYY'), TO_DATE('22-04-2015 16:00','DD-MM-YYYY HH24:MI'), 'Klein');
insert into SCHOONMAAK (SchoonmaakNr, TramNr, PersoonID, BeginDatum, EindDatumTijd, Soortbeurt)
values (5,2005,5,TO_DATE('22-04-2015','DD-MM-YYYY'), TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), 'Klein');


-- ONDERHOUD
insert into ONDERHOUD (OnderhoudsNr, TramNr, PersoonID, DatumTijdsIndicatie, BeginDatumTijd, EindDatumTijd, Soortbeurt)
values (4,2010,4,TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), TO_DATE('22-04-2015','DD-MM-YYYY'), TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), 'Klein');
insert into ONDERHOUD (OnderhoudsNr, TramNr, PersoonID, DatumTijdsIndicatie, BeginDatumTijd, EindDatumTijd, Soortbeurt)
values (5,2011,7,TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), TO_DATE('22-04-2015','DD-MM-YYYY'), TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), 'Klein');
insert into ONDERHOUD (OnderhoudsNr, TramNr, PersoonID, DatumTijdsIndicatie, BeginDatumTijd, EindDatumTijd, Soortbeurt)
values (6,2012,7,TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), TO_DATE('22-04-2015','DD-MM-YYYY'), TO_DATE('22-04-2015 17:00','DD-MM-YYYY HH24:MI'), 'Klein');
